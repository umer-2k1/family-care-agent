...
The original file under `ai-genesis-kit/history/features/` stays in place. A rollback
adds history instead of rewriting it.

_Empty until you complete your first rollback._
